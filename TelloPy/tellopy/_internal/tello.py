...
#     ############     DRONE FLIGHT PACKET PROCESSING    ##############
...
#             # print("recv: log_data: length=%d" % (len(data[9:])))
...
#         while self.state != self.STATE_QUIT and not self.killall:
...
#             if int(time.time()) % 5 == 0 and send_time and self.state== self.STATE_CONNECTED:
#                 # print("SelfState : {}".format(self.state))
