...
class Tello:
        ...
        while True:
            try:
                ...
                if len(res_string) != 1460:
                    for frame in av.open(packet_data).decode(video=0):
                        self.frame = frame
                        print(frame)
                    packet_data = ""
    ...
    #     """
    #     res_frame_list = []
    #     frames = self.decoder(packet_data)
...
connected = False
while not connected:
    connected = "OK" == drone.send_command("command") 
    time.sleep(2)

print("connected")

time.sleep(2)
print(drone.send_command("streamon"))

# time.sleep(2)
# ct = time.time()
# print(drone.takeoff())
# print("command time : {}".format(time.time()-ct))

# time.sleep(5)


# ct = time.time()
# print(drone.send_command("go 200 0 0 100"))
# print("command time : {}".format(time.time()-ct))
